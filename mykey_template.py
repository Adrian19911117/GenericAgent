...
native_oai_config = {
    'name': 'Qwen3.5-122B',                           # /llms 显示名 & mixin 引用名
    'apikey': 'sk-99999999991234',                # Bearer 鉴权
    'apibase': 'http://192.168.4.197:8086/v1/chat/completions',          # 补齐到 /v1/chat/completions
    'model': 'Qwen3.5-122B',                              # gpt-5/o 系列
